...
public class HalfCircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //定义圆的半径
        int radius = Math.min(halfWidth, height) - mCircleWidth;
        //移动坐标
    ...
    public HalfCircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = at.getColor(R.styleable.HalfCircleProgressView_textColor, Color.BLACK);
        mTextSize = at.getDimensionPixelSize(R.styleable.HalfCircleProgressView_textSize,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
